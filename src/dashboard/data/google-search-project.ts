 ...
 */
export const createGoogleSearchProject = async (userId: string, websiteId: string, domainUrl: string,  data: ProjectSchema) => {
 ...
 */
export const updateGoogleSearchProject = async (projectId: string, data: ProjectSchema) => {
