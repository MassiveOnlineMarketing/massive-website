      ...
      <ul className="flex flex-wrap md:flex-row gap-y-[18px] md:gap-11 text-sm md:text-base">
        {isCategory ? (
          <li className="mx-[6px]">
            <Link
              className={
                currentHighlight === "blog"
                  ? " px-[18px] py-[6px] md:px-[37px] md:py-3 bg-primary-500 rounded-full text-white font-semibold"
                  : "py-[6px] md:py-3 text-gray-800"
              }
              href={`${BASE_URL}/blog`}
            >
              Alles
        ...
        {categories.map((category) => (
          <li key={category.id} className="px-[6px]">
            <Link
              className={
                category.slug === currentHighlight
                  ? "px-[18px] py-[6px] md:px-[37px] md:py-3 bg-primary-500 rounded-full text-white font-semibold"
                  : "py-[6px] md:py-3 text-gray-800"
              }
              href={`${BASE_URL}/blog/categorie/${category.slug}`}
            >
              {category.title}
            </Link>
          </li>
