  ...
  return (
    ...
    >
            ...
            >
              {author.profilePicture && (
                <Image
                  src={
                    // @ts-ignore
                    `${PAYLOAD_BACKEND_URL}${author.profilePicture.url}`
                  }
      ...
      <div className="mt-6 flex flex-col md:flex-row gap-2 md:gap-6">
        <div
          className={`${styles.glass} rounded-lg w-[58px] h-[58px] px-[9px] aspect-square flex items-center justify-center`}
        >
        ...
        <div>
          ...
          <p className="text-sm leading-5 font-normal text-gray-500 ">
            Streeft ernaar om de norm te stellen voor wat mogelijk is in de
            wereld van online marketing en om zowel onszelf als onze klanten
            naar nieuwe hoogten te tillen, met behulp van innovatieve
            oplossingen en hoogwaardige diensten.
          </p>
        </div>
      </div>
    </div>
