...
import {
  ServicePricing,
  ServicePricingProps,
} from "@/website/sections/service-pricing";
...
export const metadata: Metadata = {
  ...
  description:
    "Wij ontwikkelen professionele websites die aansluiten bij jouw bedrijfsmodel, die verkeer genereren en de resultaten opleveren die jij zoekt.",
  keywords:
    "Zakelijke website laten maken, website laten maken, website ontwikkeling, webdesign, webontwikkeling, webdesign bureau",
};
    ...
    <>
      ...
      <section>
        ...
        <div className="relative">
          ...
          {/* Section 3.2 */}
          <div
            className={` ${container.sectionPadding}  ${container.maxWidth}`}
          >
            <LinksRechtsImageContainer
        ...
        <div className={` ${container.sectionPadding}  ${container.maxWidth}`}>
          ...
          >
            <div className={`${container.extraPaddingMd}`}>
              ...
              <InternalAnchor
                variant="text"
                size="sm"
                href="/blog/wordpress-vs-maatwerk-cms-keuze"
                className="text-primary-500 mt-6"
              >
                Lees Meer <ArrowRightIcon className="w-5 h-5" />
              </InternalAnchor>
            ...
            <div className=" inline-flex flex-auto justify-center  -mt-[18%]">
              <Image
                src="/zakelijke-website-laten-maken/omzet-deze-maand-kaart.jpg"
                alt="omzet deze maand"
                width={884}
                height={298}
                className="shadow-custom-lg md:max-w-[440px] rounded-lg"
              />
          ...
          {/* Cards */}
          <GridFullPageContainer
            containerStyles={`mt-8 gap-6 ${container.maxWidthGutter}`}
          >
            {SECTION33.cards.map((card, i) => (
              <li
                key={i}
                className={`py-3 px-[12px] md:py-6 flex flex-col gap-2 ${i === 0 && "border-primary-500 border-t-2"}`}
              >
                {card.icon}
                <Heading level="h4" size="base">
                  {card.heading}
  ...
  cards: [
    {
      ...
      paragraph:
        "Onze websites zijn geoptimaliseerd voor snelheid, met geavanceerde caching, efficiënte code, en de nieuwste technologieën die zorgen voor snellere laadtijden en een soepele gebruikerservaring.",
    },
    {
      icon: <CpuChipIcon className="w-5 h-5 text-primary-500" />,
      heading: "Data gedreven website & intergratie mogelijkheden",
      paragraph:
        "Wij optimaliseren jouw website met geavanceerde analytics en bieden naadloze integraties met diverse systemen en software, wat resulteert in verbeterde prestaties en gebruikerservaring.",
    },
  ],
};
  ...
  cards: [
    {
      ...
      paragraph:
        "Onze websites scoren technisch hoog in Google door een combinatie van SEO en overtuigende presentatie. Dit trekt niet alleen meer bezoekers, maar ook betrokken leads die sneller tot aankoop overgaan. De kracht ligt in de synergie tussen wat u vertelt en hoe u het presenteert.",
    },
    {
      icon: <ComputerDesktopIcon className="w-5 h-5 text-primary-500" />,
      heading: "Langdurige Klantrelaties",
      paragraph:
        "Naast de inhoudelijke boodschap draagt een professioneel ogende en gebruiksvriendelijke website bij aan een positieve gebruikerservaring.  Klanten zijn bereid meer te betalen voor merken die kwaliteit en professionaliteit uitstralen in hun online presentatie.",
    },
  ],
};
...
const PRICING: ServicePricingProps = {
  mailtoLinks: {
    mailtoLinkButton:
      "mailto:info@massiveonlinemarketing.nl?subject=Website%20Laten%20Maken%20Offerte%20Aanvraag",
    mailtoLinkModule:
      "mailto:info@massiveonlinemarketing.nl?subject=Website%20Laten%20Maken%20Module%20Interesse",
  },
  title: {
...
const FEATURES = {
  title: {
    ...
    paragraph:
      "Ontdek de kracht van volledige digitale integratie met onze unieke aanpak. Wij bieden niet alleen websiteontwikkeling, maar een uitgebreid pakket aan services die uw online aanwezigheid versterken en toekomstbestendig maken.",
  },
  cards: [
    {
    ...
    },
    {
      ...
      paragraph:
        "Als je je bereik wilt vergroten, bieden wij ook social media advertising aan. Hierbij zetten wij advertentiecampagnes op die naadloos integreren met jouw website voor een omnichannel-ervaring.",
    },
    {
      icon: <FunnelIcon />,
      heading: "Analyse en Continue Verbetering",
      paragraph:
        "Met onze expertise in website analytics, bieden wij inzichten die je helpen jouw online prestaties te begrijpen. We staan klaar om jou te ondersteunen en jouw digitale strategieën te verfijnen en verbeteren.",
    },
    {
      icon: <LinkIcon />,
      heading: "+200 Integratiemogelijkheden",
      paragraph:
        "Bij het ontwikkelen van jouw website bieden wij meer dan 200 integratiemogelijkheden zonder dat uw website traag wordt.",
    },
    {
      icon: <LockClosedIcon />,
      heading: "SSL & GDPR Gecertificeerd",
      paragraph:
        "Wij zorgen ervoor dat alle websites die wij ontwikkelen uitgerust zijn met SSL certificaten en GDPR complient zijn.",
    },
    {
      icon: <PhotoIcon />,
      heading: "Bewerking en postproductie",
      paragraph:
        "In een wereld waar visuele content regeert, bieden wij professionele fotografie- en videodiensten aan om jouw merkverhaal op je nieuwe website te versterken",
    },
  ],
};
