...
export const metadata: Metadata = {
  ...
  description:
    "Hoger komen in Google? Ontdek hoe een SEO specialist jou kan helpen met een SEO optimalisatie traject. Laat ons je de kansen van SEO marketing tonen.",
  keywords:
    "SEO, Search Engine Optimization, SEO Expert, SEO Specialist, SEO Optimalisatie, SEO Campagne, SEO Bedrijf, SEO-Bedrijf, SEO Marketing, SEO Optimalisatie, SEO Traject, SEO Audit, SEO Strategie, SEO Content, SEO Research ",
};
...
const SECTION31 = {
  content: {
    ...
    list: [
      ...
      {
        icon: (
          <DocumentMagnifyingGlassIcon className="w-5 h-5 text-primary-500" />
        ),
...
const SECTION33 = {
  content: {
    ...
    paragraph:
      "Bij ons marketingbureau begrijpen we de unieke uitdagingen waar kleine tot middelgrote bedrijven mee kampen en bieden maatwerk in zoekmachine optimalisatie om je te helpen hoger in Google te komen en uw bedrijf te laten groeien. \n \n Met onze expertise in SEO-optimalisatie en zoekmachine marketing, zijn we de partner die u nodig heeft om hoger in Google te komen en je bedrijf naar nieuwe hoogten te tillen.",
  },
  image: {
  ...
  cards: [
    {
      ...
      paragraph:
        "Grondige analyse en identificatie van relevante zoekwoorden en termen die uw doelgroep gebruikt, om de online zichtbaarheid en vindbaarheid van uw website in zoekmachines te verbeteren.",
    },
    {
      icon: <CommandLineIcon />,
      heading: "Technische SEO",
      paragraph:
        "Optimalisatie van de websiteinfrastructuur en -code om te voldoen aan de technische vereisten van zoekmachines, inclusief het verbeteren van de laadsnelheid en toegankelijkheid op mobiele apparaten.",
    },
    {
      icon: <Bars3BottomLeftIcon />,
      heading: "Content Optimalisatie en Creatie",
      paragraph:
        "Ontwikkeling van hoogwaardige, zoekmachine-geoptimaliseerde content die waarde biedt aan uw doelgroep, terwijl het ook bijdraagt aan een betere ranking in zoekmachineresultaten.",
    },
    {
      icon: <MapPinIcon />,
      heading: "Lokale SEO",
      paragraph:
        "Gerichte optimalisatie van uw online aanwezigheid om hoger te ranken in lokale zoekresultaten, essentieel voor bedrijven die een specifiek geografisch gebied bedienen.",
    },
    {
      icon: <BuildingStorefrontIcon />,
      heading: "Google Mijn Bedrijf Optimalisatie",
      paragraph:
        "Optimalisatie gericht op lokale zoekresultaten om fysieke winkels effectief onder de aandacht te brengen bij jouw doelgroep.",
    },
    {
      icon: <MagnifyingGlassIcon />,
      heading: "Verbetering en Analyse",
      paragraph:
        "Gebruikers optimalisatie om bezoekers langer vast te houden en conversies te verhogen. Inclusief gedetaieerde analyse en rapportage.",
    },
  ],
};
