    ...
    <>
      <div>
        ...
        <div className="relative flex ">
          ...
          {/* Main content */}
          <div className='fixed w-full h-full lg:ml-40 mb-8 z-[50]' style={{ width: 'calc(100vw - 160px)', minHeight: 'calc(100vh - 64px)' }}>
...
{/* <main className="py-8 lg:ml-40 w-full inner-shadow rounded-tl-3xl z-50 bg-primary-50 fixed overflow-scroll" style={{ minHeight: 'calc(100vh - 64px)' }}>
            <div className='px-4' style={{ height: 'calc(100vh - 64px)' }}>{children}</div>
          </main> */}
...
const TopBar = ({
  ...
  return (
    <div className="sticky top-0 z-50 flex h-16 shrink-0 items-center gap-x-4 bg-white px-4 shadow- sm:gap-x-6 sm:px-6 lg:px-8">
