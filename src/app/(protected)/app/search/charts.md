...
const sin = Math.sin(-RADIAN _ midAngle);
const cos = Math.cos(-RADIAN _ midAngle);
const sx = cx + (outerRadius) _ cos;
const sy = cy + (outerRadius) _ sin;
const mx = cx + (outerRadius + 5) _ cos;
const my = cy + (outerRadius + 5) _ sin;
