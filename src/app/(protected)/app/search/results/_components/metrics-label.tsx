...
export const MetricsLabelGoogleChart: React.FC<DataLabelProps> = ({ title, value, previousValue, show, setShow }) => (
    <label className={cn(
        ...
        <div>
            <p className="mb-2 text-sm leading-5 font-normal text-gray-500">{title}</p>
