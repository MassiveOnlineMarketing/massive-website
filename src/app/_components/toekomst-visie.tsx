...
const ToekomstVisie = () => {
  return (
    ...
    <div className={`px-4 ${container.maxWidthGutter}`}>
      <div className={`mt-[100px] overflow-hidden rounded-[32px] shadow-custom-lg relative gradient-mask  dark-border-gradient z-10`}>
        <div className=' px-6 md:px-12 pt-12 pb-6 md:py-[82px] gradient-toekomstvisie '>
          ...
          <InternalAnchor href={DEFAULT_MULTISTEP_FORM_ROUTE} variant='dark' size='md' className='mt-8 w-full md:w-fit'>
