  ...
  return (
    <div className="py-10 md:py-0 relative flex items-center justify-center">
      ...
      <Title className=" absolute max-w-[362px] text-center flex items-center">
        <SubHeading level="h2" size="sm" variant="pill" colorScheme="glass">
          {INTERGRATIE.subHeading}
        </SubHeading>
...
const INTERGRATIE = {
  ...
  paragraph:
    "Op maat gemaakte weboplossingen die feilloos samengaan met diverse databases, API’s en externe diensten.",
};
