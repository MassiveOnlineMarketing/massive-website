...
export const StrategieStep: React.FC<MultiStepContactFormChildProps> = ({ register, watch, errors }) => {
  ...
  return (
    <>
      <Heading level='h4' size='base' colorScheme='dark'>Met welke uitdagingen wordt u geconfronteerd met uw huidige online marketingstrategie?</Heading>
      <Textarea 
        rows={2}
      ...
      <Heading level='h4' size='base' colorScheme='dark' className='mt-6'>Welke online marketingkanalen gebruikt u momenteel?</Heading>
      ...
      <Heading level='h4' size='base' colorScheme='dark' className='mt-6'>Wat zijn uw top 3 zakelijke doelen voor het komende 12 maanden?</Heading>
      <Textarea
        rows={4}
