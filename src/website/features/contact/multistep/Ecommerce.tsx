...
export const EcommerceStep: React.FC<MultiStepContactFormChildProps> = ({
  register,
  watch,
  errors,
}) => {
  ...
  const [
    ...
    setShowOtherReasonEcomFunctionality,
  ] = useState(false);
  ...
  useEffect(() => {
    ...
    if (Array.isArray(webshopFunctionaliteit)) {
      setShowOtherReasonEcomFunctionality(
        webshopFunctionaliteit.includes("Aangepaste oplossing"),
      );
    }
