...
const NiewsbriefSignupBarFooter = ({
  containerStyles,
}: {
  ...
  return (
    ...
    >
      <form
        className={`w-full flex flex-row rounded-lg items-center  relative ${styles.glass}`}
      >
        <input
          className="h-[36px] py-2 px-5 rounded-lg w-full outline-none text-sm leading-5 font-medium text-gray-600  focus:ring-2 focus:ring-inset focus:ring-primary-500"
          {...register("email")}
