...
const NiewsbriefSignupBarBlog = ({
  ...
  return (
    <div
      className={cn(`w-fit mx-auto flex flex-col gap-[30px]`, containerStyles)}
    >
      <form
        className={`flex flex-row rounded-lg items-center p-[2px] relative ${styles.glass}`}
      >
        <input
          className="py-3 px-5 rounded-lg w-full outline-none  focus:ring-2 focus:ring-inset focus:ring-primary-500"
          {...register("email")}
