...
export const ServicePricing = ({ DATA }: { DATA: ServicePricingProps }) => {
  return (
    <div className={` ${container.sectionPadding} bg-primary-50 shadow-base`}>
      <Title
        className={`mx-auto w-fit items-center max-w-[900px] text-center mb-16 ${container.maxWidthGutter}`}
      >
        <SubHeading
          level="h2"
          size="sm"
        ...
        >
          {DATA.title.icon} {DATA.title.subHeading}
        </SubHeading>
      ...
      <div
        className={` ${container.maxWidthGutter} flex gap-6 md:gap-12 overflow-auto xl:overflow-visible scrollbar-hide snap-x snap-mandatory scroll-px-4`}
      >
