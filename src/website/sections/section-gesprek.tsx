...
const StrategischAdvies = () => {
  return (
    <div
      className={` ${container.sectionPadding} relative ${container.maxWidthGutter} md:grid grid-cols-2`}
    >
      ...
      <div className={`my-auto ${container.extraPaddingMd}`}>
        <div className="flex flex-col gap-4 pr-4">
          <SubHeading
            ...
            className="py-[6px]"
          >
            {SECTION_GESPREK.subheading}
          </SubHeading>
          <Heading level="h3" size="5xl">
            {SECTION_GESPREK.heading}
          </Heading>
      ...
      <Image
        src={"/home/massive-gratis-consulting-650x618-XL.png"}
        width={650}
        height={618}
        alt="persoon die belt met massive"
      />
    </div>
  );
};
