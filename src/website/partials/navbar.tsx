...
const NavbarTwo = () => {
  ...
  return (
    <nav >
      <div className={`fixed relateive top-0 w-full z-30 transition-transform duration-500 ease-in-out ${navbarStyle}`}>
        <div className={`px-6 py-7 rounded-b-2xl  max-w-[1300px] mx-auto bg-white ${constants.glassStroke}`}>
