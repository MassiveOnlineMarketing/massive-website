...
export const formSchema = z.object({
  ...
  dienst: z
    ...
    .optional()
    .nullable(),
  websiteFunctionaliteit: z
    .array(
      z.enum([
        "Responsief ontwerp",
        "Contact/ Reserveringssysteem",
        "Online betalingen",
  ...
  // eCommerce
  webshopFunctionaliteit: z
    .array(
      z.enum(["Shopify", "WooCommerce", "Magento", "Aangepaste oplossing"]),
    )
    .optional()
    .nullable(),
  otherReasonWebshopFunctionaliteit: z.string().optional().nullable(),
  webshopProducten: z
    .enum(["Minder dan 50", "50 tot 200", "200 tot 1000", "Meer dan 1000"])
    .optional()
    .nullable(),
  ...
  seoDoelen: z
    .array(
      z.enum([
        "Verhogen van organische zoekrangschikking",
        "Lokale zoekpresentie versterken",
  ...
  onlineAdvertentiesPlatformen: z
    .array(
      z.enum([
        "Google",
        "Facebook",
